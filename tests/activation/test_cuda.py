"""CUDA silu/relu correctness vs torch reference (also smoke-tests the JIT loader)."""

import pytest
import torch

from ref.activation import relu as relu_ref
from ref.activation import silu as silu_ref
